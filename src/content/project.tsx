...
export const projects = [
  ...
  },
  {
    ...
    gallery: [
      ...
      {
        image: blogGuides,
        aspectRatio: "3540 / 2066",
        title: "Editorial discovery",
        alt: "Streaming Calculator Blog and Guides index in light mode with featured and categorised articles",
        description:
  ...
  },
  {
    ...
    name: "Treatwell",
    shortName: "Treatwell",
    category: "Consumer marketplace · Product UX · React delivery",
    period: "2019 to 2021",
    ...
    textColor: "#171714",
    description:
      "I delivered consumer marketplace experiences across Lookbook, venue, review and booking journeys, including responsive systems, localisation and frontend quality.",
    evidenceLabel: "Product scope",
    evidence:
      "Greenfield Lookbook delivered within a small cross-functional team.",
  },
] as const;
