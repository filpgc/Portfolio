    ...
    <header className="group/site-header px-page-padding border-b-[0.5px] border-border-subtle">
      <nav className="grid min-h-16 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-2 text-[13px] sm:min-h-0">
        <Link
          ...
          className={cx(
            "group relative z-20 my-auto size-11 justify-self-start overflow-hidden rounded-full border-[0.5px] border-border-subtle outline-[0.5px] outline-offset-0 outline-transparent transition-all",
            "hover:border-text-primary/60 hover:outline-offset-10 hover:outline-border-subtle hover:shadow-sm/10 active:scale-95 sm:size-12 sm:hover:outline-offset-24",
        ...
        >
          <Image
            ...
            fill
            title="Easter egg"
            className="scale-135 bg-text-primary/20 object-contain object-bottom pt-2 "
          />
        </Link>
