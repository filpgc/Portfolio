...
export default function SelectedWork() {
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 border-b-[0.5px] border-border-subtle lg:hidden">
        <div
          role="tablist"
          aria-label="Selected projects"
          aria-orientation="horizontal"
          className="grid grid-cols-3 border-b-[0.5px] border-border-subtle"
        >
      ...
      <div className="hidden min-h-[690px] grid-cols-[minmax(290px,.72fr)_minmax(520px,1.28fr)] border-b-[0.5px] border-border-strong lg:grid">
        <div
          role="tablist"
          aria-label="Selected projects"
        ...
        >
          {projects.map((project, index) => (
            <div
              className="group not-last:border-b-[0.5px] not-last:border-b-border-subtle"
              key={project.number}
            >
