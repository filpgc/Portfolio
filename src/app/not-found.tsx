...
export default function NotFound() {
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-border-strong pb-3 text-xs font-bold uppercase tracking-widest">
        <span>404</span>
      ...
      <Link
        href="/"
        className="flex min-h-12 items-center justify-between border-t border-border-strong pt-3 text-sm font-bold"
      >
