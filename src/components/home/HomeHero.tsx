...
export default function HomeHero() {
  const summary =
    "I currently lead frontend at Outverse. Before that, I worked at Treatwell. I also run Streaming Calculator and release music as Moyo.";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col md:hidden">
        ...
        <a
          href="#work"
          className="group flex min-h-12 items-center justify-between border-b border-border-strong py-3 text-sm font-bold leading-none transition-colors duration-150 hover:border-project-accent hover:text-project-accent focus-visible:border-project-accent focus-visible:text-project-accent active:opacity-70"
        >
      ...
      <div className="mt-auto hidden grid-cols-[1fr_minmax(200px,500px)] items-end gap-10 md:mt-28 md:grid 3xl:mb-[12vh] 3xl:mt-auto">
        ...
        <a
          href="#work"
          className="group flex h-fit min-h-11 items-center justify-between border-b border-border-strong py-2 text-sm font-bold leading-none transition-colors duration-150 hover:border-project-accent hover:text-project-accent focus-visible:border-project-accent focus-visible:text-project-accent active:opacity-70"
        >
          <span>See the work</span>
          <ArrowDownIcon
            aria-hidden="true"
