export const experiences = [
  {
    ...
    summary:
      "I lead the frontend of Outverse’s AI agent platform, designing product systems for configuring intents, policies, tools and escalations, and for making RAG context, sources and reasoning understandable. Alongside product delivery, I shape the shared frontend architecture, component library and engineering practices used across the platform and embedded customer widget.",
    technologies: [
      {
        label: "Core",
        items: [
  ...
  },
  {
    ...
    summary:
      "Within a small cross-functional team, I owned frontend delivery for Lookbook from greenfield concept to a bookable discovery experience. I also shipped venue and review journeys across a mature multi-market product, learning how to move independently inside a large system.",
    technologies: [
      {
        label: "Core",
